...
MONGO_DB_URI = getenv("MONGO_DB_URI", "mongodb+srv://mando2005:mando2005@cluster0.zzuvpda.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")

DURATION_LIMIT_MIN = int(getenv("DURATION_LIMIT", 12079182787))

# Chat id of a group for logging bot's activities
LOGGER_ID = int(getenv("OWNER_ID","5772173944"))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/mandoelsaher2/mando",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/N_NIN_N")
